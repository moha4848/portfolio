export const portfolioData = {
  ...
  common: {
    fr: { 
      ...
      anecdote: "Anecdote",
      anecdoteDesc: "Je carbure au café et à la curiosité. Si je ne code pas, je suis probablement en train d'explorer une nouvelle technologie.",
    ...
    en: { 
      ...
      anecdote: "Anecdote",
      anecdoteDesc: "I run on coffee and curiosity. If I'm not coding, I'm probably exploring a new technology.",
      timeline: "Timeline",
    ...
    ar: { 
      ...
      anecdote: "نادرة",
      anecdoteDesc: "أعمل بالقهوة والفضول. إذا لم أكن أبرمج، فأنا على الأرجح أستكشف تكنولوجيا جديدة.",
    ...
    es: { 
      ...
      anecdote: "Anécdota",
      anecdoteDesc: "Me muevo por el café y la curiosidad. Si no estoy programando, probablemente esté explorando una nueva tecnología.",
      timeline: "Cronología",
